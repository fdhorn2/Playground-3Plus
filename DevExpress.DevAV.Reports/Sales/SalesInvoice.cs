...
namespace DevExpress.DevAV.Reports {
	public class SalesInvoice : DevExpress.XtraReports.UI.XtraReport {
		...
		private void InitializeComponent() {
			...
			this.xrLabel4.Font = new DevExpress.Drawing.DXFont("Arial Narrow", 12.75F);
			...
			this.xrLabel3.Font = new DevExpress.Drawing.DXFont("Arial Narrow", 12.75F);
			...
			this.xrLabel2.Font = new DevExpress.Drawing.DXFont("Arial Narrow", 12.75F);
			...
			this.xrLabel1.Font = new DevExpress.Drawing.DXFont("Arial Narrow", 12.75F);
			...
			this.xrTableCell2,
			this.xrTableCell6});
			this.xrTableRow4.Font = new DevExpress.Drawing.DXFont("Segoe UI", 11F);
			...
			this.xrTableCell7,
			this.xrTableCell8});
			this.xrTableRow5.Font = new DevExpress.Drawing.DXFont("Segoe UI", 11F, DevExpress.Drawing.DXFontStyle.Bold);
			...
			this.xrTableCell9,
			this.xrTableCell10});
			this.xrTableRow6.Font = new DevExpress.Drawing.DXFont("Segoe UI", 10F);
			...
			this.xrTableCell1});
			this.xrTableRow1.Font = new DevExpress.Drawing.DXFont("Segoe UI", 14F);
			...
			this.xrTableCell1.Font = new DevExpress.Drawing.DXFont("Segoe UI", 14F, DevExpress.Drawing.DXFontStyle.Bold);
			...
			this.xrTableCell28.Font = new DevExpress.Drawing.DXFont("Segoe UI", 12F);
			...
			this.xrTableCell29.Font = new DevExpress.Drawing.DXFont("Segoe UI", 12F);
			...
			this.xrTableCell30.Font = new DevExpress.Drawing.DXFont("Segoe UI", 12F);
			...
			this.xrTableCell31.Font = new DevExpress.Drawing.DXFont("Segoe UI", 12F);
			...
			this.xrTableCell32.Font = new DevExpress.Drawing.DXFont("Arial Narrow", 18F);
			...
			this.xrTableCell33.Font = new DevExpress.Drawing.DXFont("Segoe UI", 14F, DevExpress.Drawing.DXFontStyle.Bold);
			...
			this.xrLabel8.Font = new DevExpress.Drawing.DXFont("Arial Narrow", 12.75F);
			...
			this.xrLabel5.Font = new DevExpress.Drawing.DXFont("Arial Narrow", 12.75F);
			...
			| DevExpress.XtraPrinting.BorderSide.Right) 
			| DevExpress.XtraPrinting.BorderSide.Bottom)));
			this.xrTable5.Font = new DevExpress.Drawing.DXFont("Arial Narrow", 13F);
			...
			this.xrLabel6.Font = new DevExpress.Drawing.DXFont("Arial Narrow", 12.75F);
			...
			this.xrTableCell34.Font = new DevExpress.Drawing.DXFont("Segoe UI", 11.25F);
			...
			this.Margins = new DevExpress.Drawing.DXMargins(58, 45, 48, 94);
			...
			this.Version = "17.2";
			this.Watermark.Font = new DevExpress.Drawing.DXFont("Verdana", 54F);
			...
			this.BeforePrint += new DevExpress.XtraReports.UI.BeforePrintEventHandler(this.SalesInvoice_BeforePrint);
		...
		private void SalesInvoice_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e) {
