...
namespace DevExpress.DevAV.Reports {
	public class EmployeeTaskList : DevExpress.XtraReports.UI.XtraReport {
		...
		private void InitializeComponent() {
			...
			this.xrTable5.BeforePrint += new DevExpress.XtraReports.UI.BeforePrintEventHandler(this.xrTable5_BeforePrint);
			...
			this.xrTableCell23.Font = new DevExpress.Drawing.DXFont("Segoe UI", 11F);
			...
			this.xrLabel2.Font = new DevExpress.Drawing.DXFont("Segoe UI", 10F, DevExpress.Drawing.DXFontStyle.Italic);
	...
	" before we go to print.";
			...
			this.xrLabel1.Font = new DevExpress.Drawing.DXFont("Segoe UI", 11F, DevExpress.Drawing.DXFontStyle.Bold);
			...
			this.xrTableRow2.Font = new DevExpress.Drawing.DXFont("Tw Cen MT", 48F);
			...
			this.xrTableRow3.Font = new DevExpress.Drawing.DXFont("Segoe UI", 10F);
			...
			this.xrLabel3.Font = new DevExpress.Drawing.DXFont("Segoe UI", 14F, DevExpress.Drawing.DXFontStyle.Bold);
			...
			this.Margins = new DevExpress.Drawing.DXMargins(100, 100, 119, 100);
		...
		private void xrTable5_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e) {
