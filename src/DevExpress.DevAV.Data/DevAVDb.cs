...
namespace DevExpress.DevAV {
    ...
    public class DevAVDb : DevAVDbBase {
        public DevAVDb() : base() { }
        public DevAVDb(bool takeScreen = false) : base() {
            Constants.CreateConstants(takeScreen);
        }
        public DevAVDb(string connectionStringOrName) : base(connectionStringOrName) { }
        public DevAVDb(string connectionStringOrName, bool takeScreen = false) : base(connectionStringOrName) {
            Constants.CreateConstants(takeScreen);
        }
        static DevAVDb() {
