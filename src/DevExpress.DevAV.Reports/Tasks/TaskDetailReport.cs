...
namespace DevExpress.DevAV.Reports {
	public class TaskDetailReport : DevExpress.XtraReports.UI.XtraReport {
		...
		private void InitializeComponent() {
			...
			this.xrRichText1.Font = new DevExpress.Drawing.DXFont("Segoe UI", 11F);
			...
			this.xrTableCell9.Font = new DevExpress.Drawing.DXFont("Segoe UI", 11.5F);
			...
			this.xrGauge1.BeforePrint += new DevExpress.XtraReports.UI.BeforePrintEventHandler(this.xrGauge1_BeforePrint);
			...
			this.xrTableCell4.Font = new DevExpress.Drawing.DXFont("Segoe UI", 26F);
			...
			this.xrTableCell7.Font = new DevExpress.Drawing.DXFont("Segoe UI", 14F);
			...
			this.xrTableCell3.Font = new DevExpress.Drawing.DXFont("Segoe UI", 11.5F);
			...
			this.Margins = new DevExpress.Drawing.DXMargins(100, 100, 135, 140);
			this.Version = "18.1";
