        ...
        public static void BuildMetadata(EnumMetadataBuilder<EmployeeTaskStatus> builder) {
            builder
                .Member(EmployeeTaskStatus.NotStarted)
                    .ImageUri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Tasks/NotStarted.svg")
                .EndMember()
                .Member(EmployeeTaskStatus.NeedAssistance)
                    .ImageUri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Tasks/NeedAssistance.svg")
                .EndMember()
                .Member(EmployeeTaskStatus.InProgress)
                    .ImageUri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Tasks/InProgress.svg")
                .EndMember()
                .Member(EmployeeTaskStatus.Deferred)
                    .ImageUri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Tasks/Deferred.svg")
                .EndMember()
                .Member(EmployeeTaskStatus.Completed)
                    .ImageUri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Tasks/Completed.svg")
                .EndMember();
        }
    }
        ...
        public static void BuildMetadata(EnumMetadataBuilder<EmployeeTaskPriority> builder) {
            builder
                .Member(EmployeeTaskPriority.High)
                    .ImageUri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Priority/MediumPriority.svg")
                .EndMember()
                .Member(EmployeeTaskPriority.Low)
                    .ImageUri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Priority/LowPriority.svg")
                .EndMember()
                .Member(EmployeeTaskPriority.Normal)
                    .ImageUri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Priority/NormalPriority.svg")
                .EndMember()
                .Member(EmployeeTaskPriority.Urgent)
                    .ImageUri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Priority/HighPriority.svg")
                .EndMember();
        }
    }
}
