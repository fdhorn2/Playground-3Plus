        ...
        public static void BuildMetadata(EnumMetadataBuilder<PersonPrefix> builder) {
            builder
                .Member(PersonPrefix.Dr)
                    .ImageUri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Doctor.svg")
                .EndMember()
                .Member(PersonPrefix.Miss)
                    .ImageUri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Miss.svg")
                .EndMember()
                .Member(PersonPrefix.Mr)
                    .ImageUri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Mr.svg")
                .EndMember()
                .Member(PersonPrefix.Mrs)
                    .ImageUri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Mrs.svg")
                .EndMember()
                .Member(PersonPrefix.Ms)
                    .ImageUri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Ms.svg")
                .EndMember();
        }
    }
}
